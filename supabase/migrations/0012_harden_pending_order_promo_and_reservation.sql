-- Harden create_pending_order after the optional-promo fix.
-- Never read an unassigned promo RECORD when no promo was supplied.
-- Keep reservation expiry authoritative for every pending checkout.
