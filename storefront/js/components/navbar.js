...
function ensureStyles() {
  ...
  style.textContent = `
    ...
    .site-header__menu-link { display:flex !important; align-items:center; width:100%; padding:11px 12px; border-radius:10px; color:var(--color-text) !important; text-decoration:none; }
    ...
    @media (max-width:760px) {
      ...
      .site-header__menu { position:absolute; top:calc(100% + 10px); right:0; width:min(300px,calc(100vw - 24px)); display:grid; gap:3px; padding:8px; border:1px solid var(--color-border); border-radius:16px; background:#f3f8eb; box-shadow:var(--shadow-md); z-index:50; }
